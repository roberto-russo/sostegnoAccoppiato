...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "DEMETRA"."IE_DMT_T_CLS_CAPO_MACELLATO_03" ON "DEMETRA"."DMT_T_CLS_CAPO_MACELLATO" ("ALLEV_ID", "CAPO_ID", "FK_ID_SESSIONE") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "DEMETRA"."DMT_T_CLS_CAPO_MACELLATO" MODIFY ("FK_ID_SESSIONE" NOT NULL ENABLE);
 
  ALTER TABLE "DEMETRA"."DMT_T_CLS_CAPO_MACELLATO" ADD CONSTRAINT "PK_DMT_T_CLS_CAPO_MACELLATO" PRIMARY KEY ("ALLEV_ID", "CAPO_ID", "FK_ID_SESSIONE");
 
--------------------------------------------------------
--  Ref Constraints for Table DMT_T_CLS_CAPO_MACELLATO
--------------------------------------------------------

  ALTER TABLE "DEMETRA"."DMT_T_CLS_CAPO_MACELLATO" ADD CONSTRAINT "FK_DMT_T_SESSIONE_02" FOREIGN KEY ("FK_ID_SESSIONE")
	  REFERENCES "DEMETRA"."DMT_T_SESSIONE" ("ID_SESSIONE") ENABLE;
 
  ALTER TABLE "DEMETRA"."DMT_T_CLS_CAPO_MACELLATO" ADD CONSTRAINT "FK_DMT_D_CLS_PR_VAL_RESP_02" FOREIGN KEY ("FK_CODICE_ERRORE_MAC", "FK_NUMERO_CAPI_MAC", "FK_ID_SESSIONE_MAC")
