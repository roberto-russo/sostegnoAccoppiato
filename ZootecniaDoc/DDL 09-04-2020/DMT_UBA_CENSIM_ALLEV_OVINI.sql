...
--------------------------------------------------------
  ...
  CREATE TABLE "ZOOTECNIA"."DMT_T_UBA_CENSIM_ALLEV_OVINI" 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ZOOTECNIA"."SYS_C0012873" ON "ZOOTECNIA"."DMT_T_UBA_CENSIM_ALLEV_OVINI" ("CENSIMENTO_ID", "ID_SESSIONE", "P_ALLEV_ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "ZOOTECNIA"."UBA_CENSIM_ALLEV_OVINI" MODIFY ("CENSIMENTO_ID" NOT NULL ENABLE);
 
  ALTER TABLE "ZOOTECNIA"."UBA_CENSIM_ALLEV_OVINI" MODIFY ("ID_SESSIONE" NOT NULL ENABLE);
 
  ALTER TABLE "ZOOTECNIA"."UBA_CENSIM_ALLEV_OVINI" MODIFY ("P_ALLEV_ID" NOT NULL ENABLE);
 
  ALTER TABLE "ZOOTECNIA"."UBA_CENSIM_ALLEV_OVINI" MODIFY ("SESSIONE" NOT NULL ENABLE);
 
  ALTER TABLE "ZOOTECNIA"."DMT_T_UBA_CENSIM_ALLEV_OVINI" ADD PRIMARY KEY ("CENSIMENTO_ID", "ID_SESSIONE", "P_ALLEV_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "ZOOTECNIA"."DMT_T_UBA_CENSIM_ALLEV_OVINI" ADD CONSTRAINT "FK5L8RX9BGRAI7PUCR3QIQPWBVK" FOREIGN KEY ("SESSIONE")
