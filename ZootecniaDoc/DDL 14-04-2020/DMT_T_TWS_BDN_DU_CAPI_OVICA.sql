...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "DEMETRA"."IE_DMT_T_TWS_BDN_DU_CAP_OVCA" ON "DEMETRA"."DMT_T_TWS_BDN_DU_CAPI_OVICA" ("ID_ALLEVAMENTO", "ID_CAPO", "FK_ID_SESSIONE") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "DEMETRA"."DMT_T_TWS_BDN_DU_CAPI_OVICA" MODIFY ("FK_ID_SESSIONE" NOT NULL ENABLE);
 
--------------------------------------------------------
--  Ref Constraints for Table DMT_T_TWS_BDN_DU_CAPI_OVICA
--------------------------------------------------------

  ALTER TABLE "DEMETRA"."DMT_T_TWS_BDN_DU_CAPI_OVICA" ADD CONSTRAINT "FK_DMT_D_CLS_PR_RESP_09" FOREIGN KEY ("FK_CODICE_ERRORE_CAPI", "FK_NUMERO_CAPI_CAPI", "FK_ID_SESSIONE_CAPI")
	  REFERENCES "DEMETRA"."DMT_D_CLS_PREMIO_VAL_RESP" ("CODICE_ERRORE", "NUMERO_CAPI", "ID_SESSIONE") ENABLE;
 
  ALTER TABLE "DEMETRA"."DMT_T_TWS_BDN_DU_CAPI_OVICA" ADD CONSTRAINT "FK_DMT_T_SESSIONE_09" FOREIGN KEY ("FK_ID_SESSIONE")
