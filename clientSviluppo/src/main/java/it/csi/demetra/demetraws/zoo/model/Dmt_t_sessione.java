...
/**
 * Model per la storicizzazione della sessione. Tutti gli oggetti salvati a db
 * sono storicizzati attraverso questa classe.
 * 
...
public class Dmt_t_sessione implements Serializable {
	...
	public String toString() {
		return "Dmt_t_sessione{" + "dataEora=" + dataEora + ", idSessione=" + idSessione + ", validResp=" + validResp
				+ ", esitoContr=" + esitoContr + ", premiCapi=" + premiCapi + ", capiMacellati=" + capiMacellati
				+ ", premioValidazionePP=" + premioValidazionePP + ", premioValidazione=" + premioValidazione
				+ ", coefficientiUBA=" + coefficientiUBA + ", consistCensimUBAOvini=" + consistCensimUBAOvini
				+ ", gestori=" + gestori + ", intervento=" + intervento + ", capi=" + capi
				+ ", mensArpea=" + mensArpea + ", sintesiAnalisi=" + sintesiAnalisi + ", bovini=" + bovini
				+ ", ovicaprini=" + ovicaprini + ", circuitiQualita=" + circuitiQualita + ", calcoloInterventi="
				+ calcoloInterventi + ", contrPreamm=" + contrPreamm + ", premioCapi=" + premioCapi + ", premioZoo="
				+ premioZoo + ", ubaCensimOvini=" + ubaCensimOvini + ", logger=" + logger + ", outputControlli="
				+ outputControlli + ", outputEsclusi=" + outputEsclusi + '}';
	}
	...
	/**
	 * lista degli elementi di tipo Dmt_d_clsPremio_ValidazioneResponse associati
	 * all'id di sessione attraverso la chiave esterna.
	 */
...
//	private List<Rpu_V_pratica_zoote> zoote;
	 ...
	 *
	 * @param dataEora data e ora di inserimento dell'elemento di sessione di tipo
	 *                 Date
	 */
