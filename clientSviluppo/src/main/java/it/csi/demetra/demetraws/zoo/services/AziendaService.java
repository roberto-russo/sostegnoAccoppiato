...
public class AziendaService {
     ...
     * @return Rpu_V_pratica_zoote lista degli oggetti di tipo
     *  @see Rpu_V_pratica_zoote
     */
     ...
     * @param annoCampagna anno della campagna
     * @return Rpu_V_pratica_zoote lista di oggetti di tipo  @see Rpu_V_pratica_zoote.
     */
