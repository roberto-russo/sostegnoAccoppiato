...
@Component("ref02_009")
/**
 * Calcolo REF02.009 intervento 317 Misura 19
 * 
...
public class ClcInt317Mis19 extends Controllo {
	...
	public ClcInt317Mis19() throws  WSBridgeInternalException_Exception {
	...
	public void postEsecuzione() throws ControlloException {
		...
		try {
			 ...
			 */
			if (importoLiquidabile != 0) {
				System.out.println("REF02.009 numero capi ammissibili = " + importoLiquidabile + " azienza con cuaa "
						+ getAzienda().getCuaa());
				...
				throw new ControlloException(
						"impossibile salvare a db, nessun capo ha superato il controllo per il premio 317 misura 19");
			}
