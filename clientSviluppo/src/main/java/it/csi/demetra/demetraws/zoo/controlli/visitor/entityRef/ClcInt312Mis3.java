...
public class ClcInt312Mis3 extends Controllo{
	...
	public void preEsecuzione() throws ControlloException, CalcoloException {
		...
		try {
			...
			if(this.modelVaccheAmmesseRegCapi == null) {
				System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, SI E' VERIFICATO UN ERRORE DURANTE L'ESECUZIONE DEL CONTROLLO TEMPISITA DI REGISTRAZIONE DEI CAPI");
				...
				if(this.modelVaccheAmmesseRegCapi.isEmpty()) {
					System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, NESSUN CAPO HA SUPERATO IL CONTROLLO: TEMPISTICA DI REGISTRAZIONE CAPI");
			...
			System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, ERRORE DURANTE L'ESECUZIONE DEL CONTROLLO DELLA TEMPISTICA DI REGISTRAZIONE CAPI REF99.01");
		...
		try {
		    	...
		    	if(!modelVaccheAmmesseRegCapi.isEmpty()) {
		            ...
		            if(!resultCtlUba.isErrors()) {
		            	...
		            	System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, ERRORI DURANTE IL CONTROLLO DELLE UBA MINIME REF99.03");
		    		...
		    		System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, NON E' POSSIBILE CALCOLARE LE UBA MINIME, NESSUNA VACCA PRESENTE REF99.03");
		      ...
		      System.out.println("ERRORE DURANTE L'ESECUZIONE DEL CALCOLO INTERVENTO 312 MISURA 3");
			  throw new ControlloException(new Dmt_t_errore(getSessione(), "REF_9903", getInput(), e.getMessage()));
		  }
		if(1==1)
			System.out.println("CALCOLO INTERVENTO 312 MISURA 3, FINE PRE-ESECUZIONE");
		System.out.println("I CONTROLLI DI PRE-CALCOLO PER IL CALCOLO INTERVENTO 312 MISURA 3 SONO STATI ESEGUITI CORRETTAMENTE ✔");
	...
	public void esecuzione() throws ControlloException {
		...
		if (modelVaccheAmmesseUba != null && !modelVaccheAmmesseUba.isEmpty()) {
			...
			System.out.println("ERRORE CALCOLO INTERVENTO 312 MISURA 3, NESSUNA VACCA PRESENTE, IMPOSSIBILE ESEGUIRE IL CALCOLO DEL PREMIO REF02.003");
